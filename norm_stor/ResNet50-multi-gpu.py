...
f = open('history_CNN.txt', 'w')
f.write('#Epoch \t Loss \t Acc \t val loss \t val acc \n')
...
for epoch in range(EPOCHS):
    ...
    f.write(str(epoch) + '\t' + str(train_loss) + '\t' + str(train_accuracy.result() * 100) +
            '\t' + str(test_loss.result()) + '\t' + str(test_accuracy.result() * 100) + '\n')
...
pandas.DataFrame(history.history).to_csv("history_vgg16.csv")
